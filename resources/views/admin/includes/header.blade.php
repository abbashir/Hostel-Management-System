      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="{{url('dashboard')}}" class="navbar-brand nav-link"><img alt="branding logo" src=" {{asset('public/admin/app-assets/images/logo/robust-logo-light.png')}}" 
              data-expand=" {{asset('public/admin/app-assets/images/logo/robust-logo-light.png')}}" 
              data-collapse=" {{asset('public/admin/app-assets/images/logo/robust-logo-small.png')}}" class="brand-logo"></a></li>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="{{asset('public/admin/app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span><span class="user-name">John Doe</span></a>
